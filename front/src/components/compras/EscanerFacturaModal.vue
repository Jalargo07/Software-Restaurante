          ...
          <div>
            ...
            <div class="overflow-x-auto">
              <table class="w-full text-sm">
                ...
                <tbody>
                  <tr v-for="(item, i) in resultado.items" :key="i" class="border-b border-gray-100 dark:border-gray-800">
                    <td class="py-1 px-2"><input v-model="item.nombre" class="w-full px-2 py-1 rounded border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm"></td>
