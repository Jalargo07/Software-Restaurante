...
<template>
  <form @submit.prevent="crear">
    <div class="mb-2">
      ...
      <input v-model.number="mesaId" type="number" min="1" class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm focus:ring-2 focus:ring-[var(--color-primario)] focus:border-blue-500" placeholder="ID de mesa">
    </div>
